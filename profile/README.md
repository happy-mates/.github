...
Participants work on real IT solutions covering:

- **UX Design**: User-friendly interfaces with accessibility focus
- **Web & API Development**: Modern applications with Next.js and React
- **AI Integration**: Practical use of ChatGPT and GitHub Copilot
- **Enterprise IT**: Security, planning, and professional practices

## Our Repositories

### 🏗️ [chef](https://github.com/happy-mates/chef)
GitOps deployment orchestration for the Happy Mates ecosystem. Contains the complete framework documentation and 48-week implementation plan.

**Key Contents**:
- `HAPPY_MATES_FRAMEWORK.md` - Complete technical architecture
...
- SharePoint integrations (SPFx)
- GitOps deployments with Azure

### 📚 [knowledge](https://github.com/happy-mates/knowledge)
Documentation hub and knowledge base for the entire Happy Mates ecosystem.

**Resources for**:
- Participants: Curriculum, guides, and project ideas
- Companies: Partnership and internship information
- Contributors: Development setup and best practices
- Educators: Teaching materials and assessment criteria

## Technology Stack

We work with modern, industry-relevant technologies:

- **Frontend**: React 19, Next.js 15, TypeScript 5, Tailwind CSS
...
- **DevOps**: GitHub Actions, Kubernetes, OpenTelemetry
- **Office**: SharePoint Framework, Office.js add-ins
...
### 👨‍👩‍👧 Parents & Guardians
Supporting their children's journey to:
...
### 🏢 Companies
Seeking to:
- Access motivated IT talent
- Support diversity and inclusion
- Provide meaningful internship opportunities
- Build future employee pipelines

### 💰 Sponsors
Contributing to:
- Social responsibility initiatives
- Youth development programs
- IT industry diversity
- Community impact
...
Support Happy Mates at different levels:
...
- Send mentors to bootcamps

### As a Contributor
- Improve documentation in [knowledge](https://github.com/happy-mates/knowledge)
- Share code examples and templates
- Help build the platform in [chef](https://github.com/happy-mates/chef)
- Review and enhance the [intra365](https://github.com/happy-mates/intra365) patterns
...
- **Email**: [contact@happymates.dk](mailto:contact@happymates.dk)

## Open Source

All Happy Mates technical resources are open source and publicly available. We believe in:

- **Transparency**: Open development process
- **Collaboration**: Community contributions welcome
- **Learning**: Code as educational resource
- **Impact**: Patterns others can reuse

## License

All repositories are publicly available as part of the Happy Mates social initiative.
